...
package 
{
    ...
    public class EventMode_AllStarBaseMatch extends SSF2CustomMatch 
    {
        ...
        override public function initialize():void
        {
            var _local_8:*;
            var _local_9:Object;
            if (((this.speedUp == true) && (!(EventMode.currentInstance.matchNumber === 3))))
            {
            ...
            if (((this.speedUp == true) && (EventMode.currentInstance.matchNumber == 3)))
            {
                SSF2API.getPlayer(1).updateCharacterStats({"damageRatio":1.5});
                SSF2API.getPlayer(2).updateCharacterStats({
                    "norm_xSpeed":0.1,
                    "max_xSpeed":0.5,
                    "damageRatio":0.5,
                    "displayName":"ANGRY TAILS(BOSS)",
                    "stamina":500
                });
                SSF2API.getPlayer(2).setX(-3000);
                SSF2API.getPlayer(2).setY(-3000);
                SSF2API.getPlayer(2).setScale(4, 4);
        ...
        override public function matchSetup(_arg_1:Object):Object
        {
            ...
            if (((!(_local_2.opponent === undefined)) && (!(_local_2.bossbattle === 1))))
            {
                _local_3.playerSettings.push({
            ...
            if (((this.speedUp == true) && (EventMode.currentInstance.matchNumber == 3)))
            {
                ...
                _local_3.levelData.musicOverride = "bgm_endlessbabes";
                _local_3.levelData.hazards = false;
            };
            if (((this.speedUp == true) && (EventMode.currentInstance.matchNumber == 0)))
            {
                _local_3.levelData.musicOverride = "bgm_mutecity";
            };
            if (this.isFirstMatch())
            {
