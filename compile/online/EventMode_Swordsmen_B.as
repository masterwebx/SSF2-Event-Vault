package
{
	...
	public class EventMode_Swordsmen_B extends SSF2CustomMatch
	{
		...
		public var eventinfo:Array = [
			{
				"id":"swordsmenB",
                "classAPI":EventMode_Swordsmen_B,
                "name":"Swordsmen B-Side",
                "description":"Time for a rematch! This time, the swordsmen are working together!",
                "previewCharacter":"lloyd",
				"previewCostume":5,
                "creator":"Wex"
			}
		];
		public function EventMode_Swordsmen_B(api:*)
		{
			super(api);
		}
		...
		{			
			...
			SSF2API.getPlayer(2).setScale(1.2, 1.2);
			SSF2API.getPlayer(3).setScale(1.2, 1.2);
		}
		...
		public override function matchSetup(initSettings:Object):Object
		{
			...
			game.levelData.stage = "huecomundo";
			game.levelData.hazards = true;
			game.levelData.musicOverride = "bgm_huecomundo"
